...
def validate_add_itemto_shopping_cart():
    ...
    sleep(locators.sleep_value)
    print('Shipped to user name: ', driver.find_element(By.XPATH,
                                                        '/html[1]/body[1]/div[3]/section[1]/article[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/label[1]').text)
    sleep(locators.sleep_value)
    print('Shipped to Address : ')
    print(driver.find_element(By.XPATH,
                              '//body/div[3]/section[1]/article[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/label[1]').text)
    print(driver.find_element(By.XPATH,
                              '//body/div[3]/section[1]/article[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/label[2]').text)

    print('Phone number is: ', driver.find_element(By.XPATH,
                                                   '/html[1]/body[1]/div[3]/section[1]/article[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[3]/label[1]').text)
    print('Date ordered: ', driver.find_element(By.XPATH,
                                                '/html[1]/body[1]/div[3]/section[1]/article[1]/div[2]/div[1]/div[1]/div[2]/div[2]/label[1]').text)
    print('Total: ', driver.find_element(By.XPATH,
                                         '/html[1]/body[1]/div[3]/section[1]/article[1]/div[1]/div[2]/div[2]/label[2]').text)
